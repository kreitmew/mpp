...
text(7,2.1, paste(g_dist_holes_name," 1"), pos = 2, offset = 3.5)
text(7,1.6, g_dist_holes_expl, pos = 2, offset = -5.5)
text(7,1.1, formatC( round(input$r1ui * (pi / input$phi1ui)^0.5, digits = 8), format='f', digits=8 ) , pos = 2, offset = 1.9)
...
text(7,5.1, paste(g_dist_holes_name," 2"), pos = 2, offset = 3.5)
text(7,4.6, g_dist_holes_expl, pos = 2, offset = -5.5)
text(7,4.1, formatC( round(input$r2ui * (pi / input$phi2ui)^0.5, digits = 8), format='f', digits=8 ) , pos = 2, offset = 1.9)
...
text(7,8.1, paste(g_dist_holes_name," 3"), pos = 2, offset = 3.5)
text(7,7.6, g_dist_holes_expl, pos = 2, offset = -5.5)
text(7,7.1, formatC( round(input$r3ui * (pi / input$phi3ui)^0.5, digits = 8), format='f', digits=8 ) , pos = 2, offset = 1.9)
