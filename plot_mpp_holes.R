...
text(7,1.1,input$r1ui * (pi / input$phi1ui)^0.5, pos = 2, offset = -2.45)
...
text(7,4.1,input$r2ui * (pi / input$phi2ui)^0.5, pos = 2, offset = -2.45)
...
text(7,7.1,input$r3ui * (pi / input$phi3ui)^0.5, pos = 2, offset = -2.45)
